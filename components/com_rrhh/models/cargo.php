...
class RrhhModelCargo extends JModelAdmin{

	public function getTable($type = 'Cargos', $prefix = 'RrhhTable', $config = array()){
	...
	public function getForm($data = array(), $loadData = true){
  	...
  	protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_rrhh.edit.cargo.data', array());
