...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2016 a las 06:41:37
...
--
-- Estructura de tabla para la tabla `rrhh_assets`
--

DROP TABLE IF EXISTS `rrhh_assets`;
CREATE TABLE IF NOT EXISTS `rrhh_assets` (
...
INSERT INTO `rrhh_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(62, 1, 119, 120, 1, 'rrhh_ucm_content.1', 'rrhh_ucm_content.1', '[]'),
(63, 0, 122, 123, 0, 'com_rrhh', 'com_rrhh', '{"core.manage":{"8":1,"12":1},"core.create":{"10":1,"8":1},"core.edit":{"11":1,"8":1}}'),
(64, 8, 22, 23, 2, 'com_content.category.8', 'rrddrr', '{}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_associations`
--

DROP TABLE IF EXISTS `rrhh_associations`;
CREATE TABLE IF NOT EXISTS `rrhh_associations` (
...
--
-- Estructura de tabla para la tabla `rrhh_banners`
--

DROP TABLE IF EXISTS `rrhh_banners`;
CREATE TABLE IF NOT EXISTS `rrhh_banners` (
...
--
-- Estructura de tabla para la tabla `rrhh_banner_clients`
--

DROP TABLE IF EXISTS `rrhh_banner_clients`;
CREATE TABLE IF NOT EXISTS `rrhh_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `rrhh_banner_tracks`
--

DROP TABLE IF EXISTS `rrhh_banner_tracks`;
CREATE TABLE IF NOT EXISTS `rrhh_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `rrhh_categories`
--

DROP TABLE IF EXISTS `rrhh_categories`;
CREATE TABLE IF NOT EXISTS `rrhh_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the rrhh_assets table.',
...
--
-- Volcado de datos para la tabla `rrhh_categories`
--

INSERT INTO `rrhh_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 3, 4, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
...
(8, 64, 1, 1, 2, 1, 'rrddrr', 'com_content', 'rrddrr', 'rrddrr', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 248, '2016-05-20 03:22:54', 248, '2016-05-20 03:23:04', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_contact_details`
--

DROP TABLE IF EXISTS `rrhh_contact_details`;
CREATE TABLE IF NOT EXISTS `rrhh_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `rrhh_content`
--

DROP TABLE IF EXISTS `rrhh_content`;
CREATE TABLE IF NOT EXISTS `rrhh_content` (
...
--
-- Volcado de datos para la tabla `rrhh_content`
--
...
--
-- Estructura de tabla para la tabla `rrhh_contentitem_tag_map`
--

DROP TABLE IF EXISTS `rrhh_contentitem_tag_map`;
CREATE TABLE IF NOT EXISTS `rrhh_contentitem_tag_map` (
...
--
-- Volcado de datos para la tabla `rrhh_contentitem_tag_map`
--

INSERT INTO `rrhh_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_content_frontpage`
--

DROP TABLE IF EXISTS `rrhh_content_frontpage`;
CREATE TABLE IF NOT EXISTS `rrhh_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `rrhh_content_rating`
--

DROP TABLE IF EXISTS `rrhh_content_rating`;
CREATE TABLE IF NOT EXISTS `rrhh_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `rrhh_content_types`
--

DROP TABLE IF EXISTS `rrhh_content_types`;
CREATE TABLE IF NOT EXISTS `rrhh_content_types` (
...
--
-- Volcado de datos para la tabla `rrhh_content_types`
--

INSERT INTO `rrhh_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
(1, 'Article', 'com_content.article', '{"special":{"dbtable":"rrhh_content","key":"id","type":"Content","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"}, "special":{"fulltext":"fulltext"}}', 'ContentHelperRoute::getArticleRoute', '{"formFile":"administrator\\/components\\/com_content\\/models\\/forms\\/article.xml", "hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"} ]}'),
(2, 'Contact', 'com_contact.contact', '{"special":{"dbtable":"rrhh_contact_details","key":"id","type":"Contact","prefix":"ContactTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"address", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"image", "core_urls":"webpage", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"con_position":"con_position","suburb":"suburb","state":"state","country":"country","postcode":"postcode","telephone":"telephone","fax":"fax","misc":"misc","email_to":"email_to","default_con":"default_con","user_id":"user_id","mobile":"mobile","sortname1":"sortname1","sortname2":"sortname2","sortname3":"sortname3"}}', 'ContactHelperRoute::getContactRoute', '{"formFile":"administrator\\/components\\/com_contact\\/models\\/forms\\/contact.xml","hideFields":["default_con","checked_out","checked_out_time","version","xreference"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"], "displayLookup":[ {"sourceColumn":"created_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"catid","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"} ] }'),
(3, 'Newsfeed', 'com_newsfeeds.newsfeed', '{"special":{"dbtable":"rrhh_newsfeeds","key":"id","type":"Newsfeed","prefix":"NewsfeedsTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"link", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"numarticles":"numarticles","cache_time":"cache_time","rtl":"rtl"}}', 'NewsfeedsHelperRoute::getNewsfeedRoute', '{"formFile":"administrator\\/components\\/com_newsfeeds\\/models\\/forms\\/newsfeed.xml","hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"} ]}'),
(4, 'User', 'com_users.user', '{"special":{"dbtable":"rrhh_users","key":"id","type":"User","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"null","core_alias":"username","core_created_time":"registerdate","core_modified_time":"lastvisitDate","core_body":"null", "core_hits":"null","core_publish_up":"null","core_publish_down":"null","access":"null", "core_params":"params", "core_featured":"null", "core_metadata":"null", "core_language":"null", "core_images":"null", "core_urls":"null", "core_version":"null", "core_ordering":"null", "core_metakey":"null", "core_metadesc":"null", "core_catid":"null", "core_xreference":"null", "asset_id":"null"}, "special":{}}', 'UsersHelperRoute::getUserRoute', ''),
(5, 'Article Category', 'com_content.category', '{"special":{"dbtable":"rrhh_categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'ContentHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}]}'),
(6, 'Contact Category', 'com_contact.category', '{"special":{"dbtable":"rrhh_categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'ContactHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}]}'),
(7, 'Newsfeeds Category', 'com_newsfeeds.category', '{"special":{"dbtable":"rrhh_categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'NewsfeedsHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}]}'),
(8, 'Tag', 'com_tags.tag', '{"special":{"dbtable":"rrhh_tags","key":"tag_id","type":"Tag","prefix":"TagsTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"null", "core_xreference":"null", "asset_id":"null"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path"}}', 'TagsHelperRoute::getTagRoute', '{"formFile":"administrator\\/components\\/com_tags\\/models\\/forms\\/tag.xml", "hideFields":["checked_out","checked_out_time","version", "lft", "rgt", "level", "path", "urls", "publish_up", "publish_down"],"ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}]}'),
(9, 'Banner', 'com_banners.banner', '{"special":{"dbtable":"rrhh_banners","key":"id","type":"Banner","prefix":"BannersTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"null","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"link", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"null", "asset_id":"null"}, "special":{"imptotal":"imptotal", "impmade":"impmade", "clicks":"clicks", "clickurl":"clickurl", "custombannercode":"custombannercode", "cid":"cid", "purchase_type":"purchase_type", "track_impressions":"track_impressions", "track_clicks":"track_clicks"}}', '', '{"formFile":"administrator\\/components\\/com_banners\\/models\\/forms\\/banner.xml", "hideFields":["checked_out","checked_out_time","version", "reset"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "imptotal", "impmade", "reset"], "convertToInt":["publish_up", "publish_down", "ordering"], "displayLookup":[{"sourceColumn":"catid","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"cid","targetTable":"rrhh_banner_clients","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"created_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"modified_by","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"} ]}'),
(10, 'Banners Category', 'com_banners.category', '{"special":{"dbtable":"rrhh_categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special": {"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', '', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"], "convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}]}'),
(11, 'Banner Client', 'com_banners.client', '{"special":{"dbtable":"rrhh_banner_clients","key":"id","type":"Client","prefix":"BannersTable"}}', '', '', '', '{"formFile":"administrator\\/components\\/com_banners\\/models\\/forms\\/client.xml", "hideFields":["checked_out","checked_out_time"], "ignoreChanges":["checked_out", "checked_out_time"], "convertToInt":[], "displayLookup":[]}'),
(12, 'User Notes', 'com_users.note', '{"special":{"dbtable":"rrhh_user_notes","key":"id","type":"Note","prefix":"UsersTable"}}', '', '', '', '{"formFile":"administrator\\/components\\/com_users\\/models\\/forms\\/note.xml", "hideFields":["checked_out","checked_out_time", "publish_up", "publish_down"],"ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time"], "convertToInt":["publish_up", "publish_down"],"displayLookup":[{"sourceColumn":"catid","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}]}'),
(13, 'User Notes Category', 'com_users.category', '{"special":{"dbtable":"rrhh_categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"rrhh_ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', '', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"], "convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"access","targetTable":"rrhh_viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"rrhh_users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"rrhh_categories","targetColumn":"id","displayColumn":"title"}]}');
...
(4, 'Dirección Financiera\r\n\r\n', 2, 7, 6, 1, 5, 0, 0, 0, '2016-05-08 00:00:00', 0, '2016-05-08 00:00:00'),
(5, 'Dirección Asuntos Corporativos y RRHH', 2, 5, 8, 1, 4, 0, 0, 0, '2016-05-08 00:00:00', 0, '2016-05-08 00:00:00'),
...
--
-- Estructura de tabla para la tabla `rrhh_core_cargos`
--
...
INSERT INTO `rrhh_core_cargos` (`id_cargo`, `id_area`, `nombre`, `parent_id`, `ordering`, `level`, `disabled`, `created_by`, `created`, `modified_by`, `modified`) VALUES
(1, 2, 'Dirección Ejecutiva', 0, 1, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(2, 2, 'Dirección Comercial\r\n', 1, 2, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(3, 2, 'Dirección Planta Nobsa\r\n', 1, 3, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(4, 2, 'Dirección Asuntos Corporativos y RRHH\r\n\r\n', 1, 4, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(5, 2, 'CFO', 1, 5, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(6, 2, 'Gerente Abastecimiento\r\n', 1, 6, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(7, 2, 'Gerencia Nacional de OH&S\r\n', 1, 7, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(8, 2, 'Gerente Legal\r\n', 1, 8, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(9, 2, 'Gerente Planeación Estratégica\r\n', 1, 9, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(10, 3, 'Dirección Comercial', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(11, 3, 'Gerente Ventas Bogotá', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(12, 3, 'Gerente Ventas Norte\r\n', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(13, 3, 'Gerente Comercial Proyectos y Zona Centro', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(14, 3, 'Gerente Nacional Op. RMX', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(15, 3, 'Gerente Mercadeo e Innovación', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(16, 3, 'Gerente Logística', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(17, 3, 'Head Coach', 10, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(18, 4, 'CFO\r\n', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(19, 4, 'Jefe Tesorería\r\n\r\n', 18, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(20, 4, 'Gerente Contraloría\r\n\r\n\r\n', 18, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(21, 4, 'Jefe Contraloría\r\n\r\n\r\n\r\n', 20, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(22, 4, 'Coordinador IT\r\n\r\n\r\n\r\n\r\n', 18, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(23, 5, 'Dirección Asuntos Corporativos y RRHH', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(24, 5, 'Jefe Compensación y Beneficios', 23, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(25, 5, 'Jefe Talento\r\n', 23, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
...
(31, 6, 'Dirección Planta Nobsa', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(32, 6, 'Gerente AFR\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(33, 6, 'Gerente Producción\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(34, 6, 'Gerente Mantenimiento\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(35, 6, 'Gerente Materias Primas\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(36, 6, 'Gerente Mina\r\n', 35, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(37, 6, 'Coord. Proyectos\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(38, 6, 'Coordinador Control de Calidad\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(39, 6, 'Coord. Medio Ambiente\r\n', 31, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(40, 7, 'Gerente Producción\r\n', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(41, 7, 'Jefe Producción Clincker\r\n', 40, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(42, 7, 'Coordinador Ingeniería de Proceso\r\n\r\n', 40, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(43, 7, 'Jefe Producción Molienda\r\n\r\n', 40, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(44, 7, 'Jefe Automatización\r\n', 40, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(45, 7, 'Ingeniería Producción\r\n', 40, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(46, 7, 'Jefe Sala de Control 1\r\n', 42, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(47, 7, 'Jefe Sala de Control 2\r\n', 42, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(48, 7, 'Jefe Sala de Control 3\r\n', 42, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(49, 7, 'Jefe Sala de Control 4\r\n', 42, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(50, 8, 'Gerente Mantenimiento\r\n', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(51, 8, 'Jefe Mantenimiento Eléctrico\r\n\r\n', 50, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(52, 8, 'Jefe Mantenimiento Predictivo', 50, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(53, 8, 'Jefe Mantenimiento Mecánico', 50, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(54, 8, 'Instrumentación 1\r\n', 51, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(55, 8, 'Instrumentación 2\r\n', 51, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(56, 8, 'Instrumentación 3\r\n', 51, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(57, 9, 'Gerente Materias Primas\r\n', 0, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(58, 9, 'Gerente Mina\r\n', 57, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
(59, 9, 'Ingeniería Planeación Minera\n', 58, 0, 0, 0, 0, '2016-05-06 00:00:00', 0, '2016-05-06 00:00:00'),
...
--
-- Estructura de tabla para la tabla `rrhh_core_log_searches`
--

DROP TABLE IF EXISTS `rrhh_core_log_searches`;
CREATE TABLE IF NOT EXISTS `rrhh_core_log_searches` (
...
DROP TABLE IF EXISTS `rrhh_core_user`;
CREATE TABLE IF NOT EXISTS `rrhh_core_user` (
  ...
  `cpt` text NOT NULL COMMENT 'Campos CPT',
  `disabled` tinyint(1) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created` datetime NOT NULL,
  `modified_by` int(11) NOT NULL,
...
INSERT INTO `rrhh_core_user` (`id_user`, `id_cargo`, `date_cargo`, `date_ingreso`, `codigo`, `nombre`, `foto`, `nota`, `cpt`, `disabled`, `created_by`, `created`, `modified_by`, `modified`) VALUES
(1, 1, '2015-11-10', '2015-02-22', 1221, 'Andres Cortes', '1221.png', '2', '', 0, 0, '2016-05-10 00:00:00', 0, '2016-05-10 00:00:00'),
(2, 2, '2016-05-10', '2015-02-22', 1221, 'Andres Cortes 2', '1221.png', '2', '', 0, 0, '2016-05-10 00:00:00', 0, '2016-05-10 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_core_users_rel_tags`
--

DROP TABLE IF EXISTS `rrhh_core_users_rel_tags`;
CREATE TABLE IF NOT EXISTS `rrhh_core_users_rel_tags` (
  `id_user` int(11) NOT NULL,
  `id_tag` int(11) NOT NULL,
  UNIQUE KEY `unique` (`id_user`,`id_tag`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `rrhh_core_users_rel_tags`
--

INSERT INTO `rrhh_core_users_rel_tags` (`id_user`, `id_tag`) VALUES
(2, 3),
(2, 4);
...
--
-- Estructura de tabla para la tabla `rrhh_core_user_log`
--

DROP TABLE IF EXISTS `rrhh_core_user_log`;
CREATE TABLE IF NOT EXISTS `rrhh_core_user_log` (
  `id_user` int(11) NOT NULL AUTO_INCREMENT,
  `id_cargo` int(11) NOT NULL,
  `date_cargo` date NOT NULL COMMENT 'Fecha de ocupación del cargo',
  `date_ingreso` date NOT NULL,
...
--
-- Volcado de datos para la tabla `rrhh_core_user_log`
--

INSERT INTO `rrhh_core_user_log` (`id_user`, `id_cargo`, `date_cargo`, `date_ingreso`, `codigo`, `nombre`, `foto`, `nota`, `cpt`, `disabled`, `created_by`, `created`, `modified_by`, `modified`) VALUES
(1, 1, '2015-11-10', '2015-02-22', 1221, 'Andres Cortes', '1221.png', '2', '', 0, 0, '2016-05-10 00:00:00', 0, '2016-05-10 00:00:00'),
(2, 2, '2016-05-10', '2015-02-22', 1221, 'Andres Cortes 2', '1221.png', '2', '', 0, 0, '2016-05-10 00:00:00', 0, '2016-05-10 00:00:00');
...
--
-- Estructura de tabla para la tabla `rrhh_extensions`
--

DROP TABLE IF EXISTS `rrhh_extensions`;
CREATE TABLE IF NOT EXISTS `rrhh_extensions` (
...
--
-- Volcado de datos para la tabla `rrhh_extensions`
--

INSERT INTO `rrhh_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(23, 'com_config', 'component', 'com_config', '', 1, 1, 0, 1, '', '{"filters":{"1":{"filter_type":"NH","filter_tags":"","filter_attributes":""},"2":{"filter_type":"NH","filter_tags":"","filter_attributes":""},"12":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"11":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"10":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"8":{"filter_type":"NONE","filter_tags":"","filter_attributes":""}}}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '', '{"mediaversion":"a1f1f78e10c05244df59f6eca258d03a"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(428, 'plg_system_remember', 'plugin', 'remember', 'system', 0, 0, 1, 1, '', '', '', '', 0, '0000-00-00 00:00:00', 7, 0),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_filters`
--

DROP TABLE IF EXISTS `rrhh_finder_filters`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_filters` (
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links`
--

DROP TABLE IF EXISTS `rrhh_finder_links`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links` (
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms0`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms1`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms2`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms3`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms4`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms5`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms6`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms7`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms8`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_terms9`
--

DROP TABLE IF EXISTS `rrhh_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termsa`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termsb`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termsc`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termsd`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termse`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_links_termsf`
--

DROP TABLE IF EXISTS `rrhh_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_taxonomy`
--

DROP TABLE IF EXISTS `rrhh_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `rrhh_finder_taxonomy`
--

INSERT INTO `rrhh_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `rrhh_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `rrhh_finder_terms`
--

DROP TABLE IF EXISTS `rrhh_finder_terms`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_terms` (
...
--
-- Estructura de tabla para la tabla `rrhh_finder_terms_common`
--

DROP TABLE IF EXISTS `rrhh_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `rrhh_finder_terms_common`
--

INSERT INTO `rrhh_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `rrhh_finder_tokens`
--

DROP TABLE IF EXISTS `rrhh_finder_tokens`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `rrhh_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `rrhh_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `rrhh_finder_types`
--

DROP TABLE IF EXISTS `rrhh_finder_types`;
CREATE TABLE IF NOT EXISTS `rrhh_finder_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `rrhh_languages`
--

DROP TABLE IF EXISTS `rrhh_languages`;
CREATE TABLE IF NOT EXISTS `rrhh_languages` (
...
--
-- Volcado de datos para la tabla `rrhh_languages`
--

INSERT INTO `rrhh_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_menu`
--

DROP TABLE IF EXISTS `rrhh_menu`;
CREATE TABLE IF NOT EXISTS `rrhh_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to rrhh_menu_types.menutype',
  ...
  `component_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to rrhh_extensions.id',
  `checked_out` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to rrhh_users.id',
...
(2, 'menu', 'com_banners', 'Banners', '', 'Banners', 'index.php?option=com_banners', 'component', 0, 1, 1, 4, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners', 0, '', 11, 20, 0, '*', 1),
(3, 'menu', 'com_banners', 'Banners', '', 'Banners/Banners', 'index.php?option=com_banners', 'component', 0, 2, 2, 4, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners', 0, '', 12, 13, 0, '*', 1),
(4, 'menu', 'com_banners_categories', 'Categories', '', 'Banners/Categories', 'index.php?option=com_categories&extension=com_banners', 'component', 0, 2, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-cat', 0, '', 14, 15, 0, '*', 1),
(5, 'menu', 'com_banners_clients', 'Clients', '', 'Banners/Clients', 'index.php?option=com_banners&view=clients', 'component', 0, 2, 2, 4, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-clients', 0, '', 16, 17, 0, '*', 1),
(6, 'menu', 'com_banners_tracks', 'Tracks', '', 'Banners/Tracks', 'index.php?option=com_banners&view=tracks', 'component', 0, 2, 2, 4, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-tracks', 0, '', 18, 19, 0, '*', 1),
...
(108, 'invisible', 'Home', 'home', '', 'home', 'index.php?option=com_users&view=login', 'component', 1, 1, 1, 25, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"login_redirect_url":"index.php?option=com_rrhh?view=rrhh","logindescription_show":"1","login_description":"","login_image":"","logout_redirect_url":"","logoutdescription_show":"1","logout_description":"","logout_image":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 1, '*', 0),
(109, 'mainmenu', 'Cargos', 'cargos', '', 'cargos', 'index.php?option=com_rrhh&view=cargos', 'component', 1, 1, 1, 701, 0, '0000-00-00 00:00:00', 0, 3, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 3, 6, 0, '*', 0),
...
--
-- Volcado de datos para la tabla `rrhh_menu_types`
--
...
--
-- Estructura de tabla para la tabla `rrhh_messages`
--

DROP TABLE IF EXISTS `rrhh_messages`;
CREATE TABLE IF NOT EXISTS `rrhh_messages` (
...
--
-- Estructura de tabla para la tabla `rrhh_messages_cfg`
--

DROP TABLE IF EXISTS `rrhh_messages_cfg`;
CREATE TABLE IF NOT EXISTS `rrhh_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `rrhh_modules`
--

DROP TABLE IF EXISTS `rrhh_modules`;
CREATE TABLE IF NOT EXISTS `rrhh_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the rrhh_assets table.',
...
--
-- Volcado de datos para la tabla `rrhh_modules`
--
...
--
-- Estructura de tabla para la tabla `rrhh_modules_menu`
--

DROP TABLE IF EXISTS `rrhh_modules_menu`;
CREATE TABLE IF NOT EXISTS `rrhh_modules_menu` (
...
--
-- Volcado de datos para la tabla `rrhh_modules_menu`
--

INSERT INTO `rrhh_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `rrhh_newsfeeds`
--

DROP TABLE IF EXISTS `rrhh_newsfeeds`;
CREATE TABLE IF NOT EXISTS `rrhh_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `rrhh_overrider`
--

DROP TABLE IF EXISTS `rrhh_overrider`;
CREATE TABLE IF NOT EXISTS `rrhh_overrider` (
...
--
-- Estructura de tabla para la tabla `rrhh_postinstall_messages`
--

DROP TABLE IF EXISTS `rrhh_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `rrhh_postinstall_messages` (
  `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `extension_id` bigint(20) NOT NULL DEFAULT '700' COMMENT 'FK to rrhh_extensions',
...
--
-- Volcado de datos para la tabla `rrhh_postinstall_messages`
--

INSERT INTO `rrhh_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `rrhh_redirect_links`
--

DROP TABLE IF EXISTS `rrhh_redirect_links`;
CREATE TABLE IF NOT EXISTS `rrhh_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `rrhh_schemas`
--

DROP TABLE IF EXISTS `rrhh_schemas`;
CREATE TABLE IF NOT EXISTS `rrhh_schemas` (
...
--
-- Estructura de tabla para la tabla `rrhh_session`
--

DROP TABLE IF EXISTS `rrhh_session`;
CREATE TABLE IF NOT EXISTS `rrhh_session` (
...
--
-- Volcado de datos para la tabla `rrhh_session`
--

INSERT INTO `rrhh_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('fdvpmoe65kqg6q17etpjf1iv11', 0, 0, '1464003263', 'joomla|s:2704:"";', 250, 'administrador');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_tags`
--

DROP TABLE IF EXISTS `rrhh_tags`;
CREATE TABLE IF NOT EXISTS `rrhh_tags` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `rrhh_tags`
--
...
(2, 1, 1, 4, 1, 'Fortalezas', 'Fortalezas', 'Fortalezas', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 849, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 6, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 1, 5, 8, 1, 'Desarrollo', 'Desarrollo', 'Desarrollo', '', '', 1, 0, '2013-11-16 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 849, '2013-11-16 00:00:00', '', 0, '2013-11-16 00:00:00', '', '', 5, '*', 1, '2013-11-16 00:00:00', '2013-11-16 00:00:00'),
(4, 2, 2, 3, 2, 'Fortalezas/autodidacta', 'Autodidacta', 'autodidacta', '', '', 1, 0, '2016-05-23 02:31:37', 1, '{"tag_layout":"","tag_link_class":"label label-info"}', '', '', '{"author":"","robots":""}', 248, '2016-05-23 02:31:37', '', 0, '2016-05-23 02:31:37', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{}', 0, '*', 1, '2016-05-23 02:31:37', '2016-05-23 02:31:37'),
(5, 3, 6, 7, 2, 'Desarrollo/organizado', 'Organizado', 'organizado', '', '', 1, 0, '2016-05-23 02:31:56', 1, '{"tag_layout":"","tag_link_class":"label label-info"}', '', '', '{"author":"","robots":""}', 248, '2016-05-23 02:31:56', '', 0, '2016-05-23 02:31:56', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{}', 0, '*', 1, '2016-05-23 02:31:56', '2016-05-23 02:31:56');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_template_styles`
--

DROP TABLE IF EXISTS `rrhh_template_styles`;
CREATE TABLE IF NOT EXISTS `rrhh_template_styles` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `rrhh_template_styles`
--

INSERT INTO `rrhh_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(7, 'protostar', 0, '1', 'protostar - Default', '{"templateColor":"#278dad","templateBackgroundColor":"#f4f6f7","logoFile":"images\\/Logo.png","sitetitle":"","sitedescription":"","googleFont":"1","googleFontName":"Lato","fluidContainer":"1"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_ucm_base`
--

DROP TABLE IF EXISTS `rrhh_ucm_base`;
CREATE TABLE IF NOT EXISTS `rrhh_ucm_base` (
...
--
-- Volcado de datos para la tabla `rrhh_ucm_base`
--

INSERT INTO `rrhh_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_ucm_content`
--

DROP TABLE IF EXISTS `rrhh_ucm_content`;
CREATE TABLE IF NOT EXISTS `rrhh_ucm_content` (
  ...
  `asset_id` int(10) UNSIGNED DEFAULT NULL COMMENT 'FK to the rrhh_assets table.',
...
--
-- Volcado de datos para la tabla `rrhh_ucm_content`
--

INSERT INTO `rrhh_ucm_content` (`core_content_id`, `core_type_alias`, `core_title`, `core_alias`, `core_body`, `core_state`, `core_checked_out_time`, `core_checked_out_user_id`, `core_access`, `core_params`, `core_featured`, `core_metadata`, `core_created_user_id`, `core_created_by_alias`, `core_created_time`, `core_modified_user_id`, `core_modified_time`, `core_language`, `core_publish_up`, `core_publish_down`, `core_content_item_id`, `asset_id`, `core_images`, `core_urls`, `core_hits`, `core_version`, `core_ordering`, `core_metakey`, `core_metadesc`, `core_catid`, `core_xreference`, `core_type_id`) VALUES
...
--
-- Estructura de tabla para la tabla `rrhh_ucm_history`
--

DROP TABLE IF EXISTS `rrhh_ucm_history`;
CREATE TABLE IF NOT EXISTS `rrhh_ucm_history` (
...
--
-- Volcado de datos para la tabla `rrhh_ucm_history`
--

INSERT INTO `rrhh_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
...
(3, 8, 5, '', '2016-05-20 03:22:54', 248, 549, '17119041c69699d6b29affc456e62c91b6b650d8', '{"id":8,"asset_id":64,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_content","title":"rrddrr","alias":"rrddrr","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"248","created_time":"2016-05-20 03:22:54","modified_user_id":null,"modified_time":"2016-05-20 03:22:54","hits":"0","language":"*","version":null}', 0),
(4, 4, 8, '', '2016-05-23 02:31:37', 248, 858, '6fed66636899f06f9fba11c72331dd7573bddd71', '{"id":4,"parent_id":"2","lft":"2","rgt":3,"level":2,"path":null,"title":"Autodidacta","alias":"autodidacta","note":"","description":"","published":"1","checked_out":null,"checked_out_time":"2016-05-23 02:31:37","access":"1","params":"{\\"tag_layout\\":\\"\\",\\"tag_link_class\\":\\"label label-info\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"248","created_time":"2016-05-23 02:31:37","created_by_alias":"","modified_user_id":null,"modified_time":"2016-05-23 02:31:37","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{}","hits":"0","language":"*","version":null,"publish_up":"2016-05-23 02:31:37","publish_down":"2016-05-23 02:31:37"}', 0),
(5, 5, 8, '', '2016-05-23 02:31:56', 248, 856, '3f5d7d959395e1f7462929cdf6a799dda7f2da87', '{"id":5,"parent_id":"3","lft":"6","rgt":7,"level":2,"path":null,"title":"Organizado","alias":"organizado","note":"","description":"","published":"1","checked_out":null,"checked_out_time":"2016-05-23 02:31:56","access":"1","params":"{\\"tag_layout\\":\\"\\",\\"tag_link_class\\":\\"label label-info\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"248","created_time":"2016-05-23 02:31:56","created_by_alias":"","modified_user_id":null,"modified_time":"2016-05-23 02:31:56","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{}","hits":"0","language":"*","version":null,"publish_up":"2016-05-23 02:31:56","publish_down":"2016-05-23 02:31:56"}', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_updates`
--

DROP TABLE IF EXISTS `rrhh_updates`;
CREATE TABLE IF NOT EXISTS `rrhh_updates` (
...
--
-- Volcado de datos para la tabla `rrhh_updates`
--

INSERT INTO `rrhh_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(12, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.5.1.1', '', 'https://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
...
(48, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.5.1.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(49, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.5.0.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
...
--
-- Estructura de tabla para la tabla `rrhh_update_sites`
--

DROP TABLE IF EXISTS `rrhh_update_sites`;
CREATE TABLE IF NOT EXISTS `rrhh_update_sites` (
...
--
-- Volcado de datos para la tabla `rrhh_update_sites`
--

INSERT INTO `rrhh_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1463970673, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1463970673, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1463970671, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1463970671, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_update_sites_extensions`
--

DROP TABLE IF EXISTS `rrhh_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `rrhh_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `rrhh_update_sites_extensions`
--

INSERT INTO `rrhh_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 704),
...
--
-- Estructura de tabla para la tabla `rrhh_usergroups`
--

DROP TABLE IF EXISTS `rrhh_usergroups`;
CREATE TABLE IF NOT EXISTS `rrhh_usergroups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `rrhh_usergroups`
--

INSERT INTO `rrhh_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 12, 'Public'),
(2, 1, 2, 9, 'Registered'),
(8, 1, 10, 11, 'Super Users'),
(10, 11, 5, 6, 'Maneger RRhh'),
(11, 12, 4, 7, 'Administración RRHH'),
(12, 2, 3, 8, 'Consulta RRHH');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rrhh_users`
--

DROP TABLE IF EXISTS `rrhh_users`;
...
--
-- Volcado de datos para la tabla `rrhh_users`
--
...
(248, 'Super User', 'Admin', 'andres.cortesb@gmail.com', '$2y$10$pe7l7cyuf8G2q/oSlEfWaO3QaIt4J2DNyjkHiTCQlPSfCw5h7iE1e', 0, 1, '2016-04-27 02:51:04', '2016-05-23 02:31:09', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
...
(250, 'Administrador', 'administrador', 'administrador@hhrr.co', '$2y$10$russd0nhxHbCi1ZLMOyGP.399cp5Si7zurkqj1/IZf5sp1bZ3Fsqa', 0, 0, '2016-05-06 02:34:44', '2016-05-23 11:05:39', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
...
--
-- Estructura de tabla para la tabla `rrhh_user_keys`
--

DROP TABLE IF EXISTS `rrhh_user_keys`;
CREATE TABLE IF NOT EXISTS `rrhh_user_keys` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `rrhh_user_notes`
--

DROP TABLE IF EXISTS `rrhh_user_notes`;
CREATE TABLE IF NOT EXISTS `rrhh_user_notes` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `rrhh_user_profiles`
--

DROP TABLE IF EXISTS `rrhh_user_profiles`;
CREATE TABLE IF NOT EXISTS `rrhh_user_profiles` (
...
--
-- Estructura de tabla para la tabla `rrhh_user_usergroup_map`
--

DROP TABLE IF EXISTS `rrhh_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `rrhh_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to rrhh_users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to rrhh_usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `rrhh_user_usergroup_map`
--

INSERT INTO `rrhh_user_usergroup_map` (`user_id`, `group_id`) VALUES
(248, 8),
(249, 2),
(249, 10),
(250, 2),
...
--
-- Estructura de tabla para la tabla `rrhh_viewlevels`
--

DROP TABLE IF EXISTS `rrhh_viewlevels`;
CREATE TABLE IF NOT EXISTS `rrhh_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla `rrhh_viewlevels`
--

INSERT INTO `rrhh_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 2, '[2,8]'),
(3, 'Administrador', 3, '[11,10,8]'),
(5, 'Guest', 1, '[]'),
(6, 'Super Users', 4, '[8]');
